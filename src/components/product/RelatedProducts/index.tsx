      ...
      <Container>
        ...
        >
          {products.map((product, index) => (
            ...
            >
              <Link href={`/categories/${product.slug}`} className="group block">
                <div className="overflow-hidden rounded-2xl border border-luxury-border bg-white transition-all duration-500 luxury-shadow hover:border-luxury-gold/40 hover:luxury-shadow-hover">
                  <div className="relative aspect-[4/5] overflow-hidden">
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.9 }}
                      className="absolute right-3 top-3 flex h-9 w-9 items-center justify-center rounded-full bg-white/90 text-luxury-text opacity-0 backdrop-blur-sm transition-all duration-300 hover:bg-luxury-gold hover:text-white group-hover:opacity-100"
